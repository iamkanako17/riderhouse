class LodgingsController < ApplicationController
  ...
  def lodge_params
    params.require(:lodging).permit(:lodge_name, :price, :postcode, :prefecture_city, :block_number, :building, :phone, :description, images: []).merge(host_user_id: current_host_user.id)
